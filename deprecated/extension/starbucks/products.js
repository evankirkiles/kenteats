	...
	pullMenu() {
		return new Promise(resolve => {
			request.get({
				...
				for (let i = 0; i < this.fullproducts['menus'].length; i++) {
					this.traverseLevel(this.fullproducts['menus'][i])
				}
				resolve()
			})
		})
